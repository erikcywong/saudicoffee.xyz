...
T = {
  ...
  "technology": {
    ...
    "patent_applicant": {"en": "Applicant: Guangzhou Herang Modern Agriculture Technology Co., Ltd. | Inventors: Zhuang Xuexiong, Wu Jingrui, Chen Baoshan", "zh": "申请人：广州禾穰现代农业科技有限公司 | 发明人：庄学雄、吴镜锐、陈宝珊", "ar": "مقدم الطلب: شركة قوانغتشو هيرانغ للتقنية الزراعية الحديثة المحدودة | المخترعون: تشوانغ شيويشيونغ، وو جينغروي، تشن باوشان"},
    ...
    "s2_li4": {"en": "Flowering induction: P/K boost + short-day + 16-18°C nights → first bloom at 8-10 months", "zh": "开花诱导：磷钾提升+短日照+16-18°C夜间 → 8-10个月首次开花", "ar": "تحفيز الإزهار: تعزيز P/K + يوم قصير + ليالي 16-18°م → أول تفتح في 8-10 أشهر"},
    ...
    "metric2_val": {"en": "10 mo", "zh": "10个月", "ar": "10 شهر"},
...
def page_technology():
  ...
  <div class="card-grid col3" style="margin-top:24px">
    ...
    <div class="card" style="text-align:center"><div class="metric-large" style="color:var(--green)" data-i18n="technology.metric2_val">10 mo</div><div class="metric-label" data-i18n="technology.metric2_lbl">First Harvest</div><p style="margin-top:8px" data-i18n="technology.metric2_desc"></p></div>
